...
@FeignClient(value = "${blindspottxns.service.name}", url = "${blindspottxns.service.url}", configuration = FeignClientConfiguration.class)
public interface BlindspotTransactionsClient {
	...
	public ResponseEntity<TransactionsResponse> rtltransactions(@RequestHeader(value = "X-Orig-App") String origApp,
			...
			/*@RequestParam(value = "debit", required = false, defaultValue = "false") Boolean debitFlag,
			@RequestParam(value = "credit", required = false, defaultValue = "false") Boolean creditFlag,*/
			...
			@RequestParam(value = "start-time", required = false) LocalTime startTime,
			@RequestParam(value = "end-time", required = false) LocalTime endTime,
			...
			@RequestParam(value = "next-load-date", required = false) String lastLoadDate,
