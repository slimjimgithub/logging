...
@FeignClient(value = "${intradaytxns.service.name}", url = "${intradaytxns.service.url}", configuration = FeignClientConfiguration.class)
public interface IntradayTransactionsClient {
	@GetMapping(value = "/accounts/transactions", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
