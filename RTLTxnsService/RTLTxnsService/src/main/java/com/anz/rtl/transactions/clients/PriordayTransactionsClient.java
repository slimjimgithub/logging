...
@FeignClient(value = "${priordaytxns.service.name}", url = "${priordaytxns.service.url}", configuration = FeignClientConfiguration.class)
public interface PriordayTransactionsClient {
